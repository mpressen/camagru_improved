<div class="frame-container dropzones" id="frame-container">
	<img class="frames" src="/images/cat-wtf.png" id='cat-wtf'>
	<img class="frames" src="/images/hair.png" id='hair'>
	<img class="frames" src="/images/pipe.png" id='pipe'>
</div>
<div class="workshop-container">
	<div class="centered">
		...
		<a id="take-picture" class="button smile">TAKE PICTURE</a>
		<div id="picture_taken" class="preview-container " id="preview-container">
			<img id="photo">
		</div>
